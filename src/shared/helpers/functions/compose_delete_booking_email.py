            ...
            <td>
                ...
                <tr>
                    ...
                    <div class="TextsBox" style="word-wrap: break-word;">
                        <h2 style="color: #72310E;">Obrigado, NOME USUÁRIO<p>Seu feedback foi enviado para nossa equipe analisar:</p></h2>
                        <h4 style="color: #726057;">MENSAGEM</h4>
                        <h4 style="color: #726057;">DATA</h4>
                    </div>
                    </td>
                </tr>
                </table>
