...
class TestGetAllBookingsPresenter:
    def test_lambda_handler(self):
        event = {
            ...
            "body": '{"start_date": 1738940138, "end_date": 1838940138, "court_number": 1, "sport": "FOOTBALL", "user_id": "d3b07384-d9a1-4e8a-b3ef-4f1d2a87c6f5", "booking_id": "a1f5e2c3-7d8b-4c9e-b012-34f6a789d0e1", "materials": ["ball"]}',
            "pathParameters": None,
